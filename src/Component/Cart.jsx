      ...
      <div className="bg-white rounded-[45px] border-2 border-cyan-300 p-10 shadow-2xl">
        ...
        {cardata.length === 0 ? (
          ...
          <div className="space-y-6">
            {cardata.map((item) => (
              <div key={item.id} className="flex items-center justify-between p-6 bg-gray-50 rounded-[30px] border border-gray-100 transition-all hover:bg-white hover:shadow-md group">
                <div className="flex items-center gap-6">
                  <span className="text-4xl bg-white p-3 rounded-2xl shadow-sm group-hover:scale-110 transition-transform">
                    {item.icon || '📦'}
                  </span>
                  <div>
                ...
                <button 
                  ...
                  className="text-red-500 font-bold hover:bg-red-50 px-5 py-2 rounded-full transition-all border border-transparent hover:border-red-100"
                >
                  Remove
                </button>
              </div>
            ...
            <div className="flex justify-between items-center pt-10 border-t border-gray-100">
              ...
              <span className="text-5xl font-black text-gray-900">${total.toLocaleString()}</span>
            </div>
