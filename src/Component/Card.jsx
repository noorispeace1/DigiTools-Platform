...
const Card = ({ modelPromise }) => {
  // Load data using React's use() hook
  const models = use(modelPromise);

  console.log(models); // For debugging
          ...
          {models.map((model) => (
            ...
            >
              <div className="p-8">
                ...
                {/* Buy Now Button */}
                <button   className="w-full bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white font-semibold py-4 rounded-2xl text-lg transition-all duration-300 active:scale-95 shadow-lg shadow-purple-500/30">
                  Buy Now
                </button>
              </div>
            </div>
